...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.showPetNames': '펫 이름표 표시',
  ...
  'entities.items.whistle_ember_fox.name': '잉걸불 여우 호루라기',
  'entities.items.whistle_moss_hare.name': '이끼 산토끼 호루라기',
  'entities.items.whistle_frog.name': '개구리 호루라기',
  'entities.items.whistle_crimson_claw_crab.name': '진홍 발톱 게 호루라기',
  'entities.items.whistle_golden_sentinel.name': '황금 파수병 호루라기',
  'entities.items.whistle_nightfang.name': '나이트팽 호루라기',
  'entities.items.whistle_tuskhorn_boar.name': '엄니뿔 멧돼지 호루라기',
  'entities.items.whistle_emerald_wolf.name': '에메랄드 늑대 호루라기',
  'entities.items.whistle_tiger.name': '호랑이 호루라기',
  'entities.items.whistle_cate_coin.name': '케이트 코인 호루라기',
  'entities.items.whistle_dragon.name': '드래곤 호루라기',
  'entities.items.whistle_alon.name': '알론 호루라기',
  'entities.items.whistle_trollface.name': '트롤페이스 호루라기',
  'entities.items.whistle_ansem.name': '안셈 호루라기',
  'entities.items.whistle_triple_t.name': '트리플 T 호루라기',
  'entities.items.whistle_kekius.name': '케키우스 호루라기',
  'entities.items.whistle_solbot.name': '솔봇 호루라기',
  'entities.items.whistle_frostfire.name': '서리불꽃 호루라기',
  'entities.items.whistle_rocky.name': '록키 호루라기',
  'entities.mobs.buddy_ember_fox.name': '잉걸불 여우',
  'entities.mobs.buddy_moss_hare.name': '이끼 산토끼',
  'entities.mobs.buddy_frog.name': '개구리',
  'entities.mobs.buddy_crimson_claw_crab.name': '진홍 발톱 게',
  'entities.mobs.buddy_golden_sentinel.name': '황금 파수병',
  'entities.mobs.buddy_nightfang.name': '나이트팽',
  ...
  'entities.mobs.buddy_cate_coin.name': '케이트 코인',
  'entities.mobs.buddy_dragon.name': '드래곤',
  'entities.mobs.buddy_alon.name': '알론',
  ...
  'entities.mobs.buddy_rocky.name': '록키',
