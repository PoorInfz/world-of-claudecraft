...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.showPetNames': '顯示寵物姓名板',
  ...
  'entities.items.whistle_ember_fox.name': '餘燼狐狸哨子',
  'entities.items.whistle_moss_hare.name': '苔蘚野兔哨子',
  'entities.items.whistle_frog.name': '青蛙哨子',
  'entities.items.whistle_crimson_claw_crab.name': '緋爪蟹哨子',
  'entities.items.whistle_golden_sentinel.name': '黃金哨兵哨子',
  'entities.items.whistle_nightfang.name': '夜牙哨子',
  'entities.items.whistle_tuskhorn_boar.name': '獠角野豬哨子',
  'entities.items.whistle_emerald_wolf.name': '翡翠狼哨子',
  'entities.items.whistle_tiger.name': '老虎哨子',
  'entities.items.whistle_cate_coin.name': '凱特金幣哨子',
  'entities.items.whistle_dragon.name': '巨龍哨子',
  'entities.items.whistle_alon.name': '阿隆哨子',
  'entities.items.whistle_trollface.name': '巨魔臉哨子',
  'entities.items.whistle_ansem.name': '安森哨子',
  'entities.items.whistle_triple_t.name': '三重T哨子',
  'entities.items.whistle_kekius.name': '凱基烏斯哨子',
  'entities.items.whistle_solbot.name': '索爾機器人哨子',
  'entities.items.whistle_frostfire.name': '霜火哨子',
  'entities.items.whistle_rocky.name': '洛奇哨子',
  'entities.mobs.buddy_ember_fox.name': '餘燼狐狸',
  'entities.mobs.buddy_moss_hare.name': '苔蘚野兔',
  'entities.mobs.buddy_frog.name': '青蛙',
  'entities.mobs.buddy_crimson_claw_crab.name': '緋爪蟹',
  ...
  'entities.mobs.buddy_cate_coin.name': '凱特金幣',
  'entities.mobs.buddy_dragon.name': '巨龍',
  ...
  'entities.mobs.buddy_solbot.name': '索爾機器人',
