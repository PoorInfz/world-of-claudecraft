...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.showPetNames': '显示宠物姓名板',
  ...
  'entities.items.whistle_ember_fox.name': '余烬狐狸哨子',
  'entities.items.whistle_moss_hare.name': '苔藓野兔哨子',
  'entities.items.whistle_frog.name': '青蛙哨子',
  'entities.items.whistle_crimson_claw_crab.name': '绯爪蟹哨子',
  'entities.items.whistle_golden_sentinel.name': '黄金哨兵哨子',
  'entities.items.whistle_nightfang.name': '夜牙哨子',
  'entities.items.whistle_tuskhorn_boar.name': '獠角野猪哨子',
  'entities.items.whistle_emerald_wolf.name': '翡翠狼哨子',
  'entities.items.whistle_tiger.name': '老虎哨子',
  'entities.items.whistle_cate_coin.name': '凯特金币哨子',
  'entities.items.whistle_dragon.name': '巨龙哨子',
  'entities.items.whistle_alon.name': '阿隆哨子',
  'entities.items.whistle_trollface.name': '巨魔脸哨子',
  'entities.items.whistle_ansem.name': '安森哨子',
  'entities.items.whistle_triple_t.name': '三重T哨子',
  'entities.items.whistle_kekius.name': '凯基乌斯哨子',
  'entities.items.whistle_solbot.name': '索尔机器人哨子',
  'entities.items.whistle_frostfire.name': '霜火哨子',
  'entities.items.whistle_rocky.name': '洛奇哨子',
  'entities.mobs.buddy_ember_fox.name': '余烬狐狸',
  'entities.mobs.buddy_moss_hare.name': '苔藓野兔',
  'entities.mobs.buddy_frog.name': '青蛙',
  'entities.mobs.buddy_crimson_claw_crab.name': '绯爪蟹',
  ...
  'entities.mobs.buddy_tiger.name': '老虎',
  'entities.mobs.buddy_cate_coin.name': '凯特金币',
  'entities.mobs.buddy_dragon.name': '巨龙',
  'entities.mobs.buddy_alon.name': '阿隆',
  'entities.mobs.buddy_trollface.name': '巨魔脸',
  'entities.mobs.buddy_ansem.name': '安森',
  'entities.mobs.buddy_triple_t.name': '三重T',
  'entities.mobs.buddy_kekius.name': '凯基乌斯',
  'entities.mobs.buddy_solbot.name': '索尔机器人',
  'entities.mobs.buddy_frostfire.name': '霜火',
  'entities.mobs.buddy_rocky.name': '洛奇',
