...
// every other item.
// Empty again (2026-08-28) after the buddy whistle set's own committed art
// landed: rendered from each buddy's own shipped GLB
// (scripts/assets/render_buddy_item_icons.mjs, public/models/buddies/*.glb),
// the same "rendered from its own world model" lineage as the Proving Shore
// pair above, not the docs/design/item-icon-art-style.md painted style.
